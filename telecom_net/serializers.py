...
class InfrastructureObjectSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'address', 'lat', 'lng', 'capacity', 'free_ports', 'parent', 'parent_name',
            'photo', 'photo_url', 'diagram', 'diagram_url', 'technical_notes',
...
class CableRouteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CableRoute
        fields = [
            'id', 'name', 'from_object', 'from_object_name', 'from_object_type',
            'to_object', 'to_object_name', 'to_object_type', 'cable_type', 'cable_type_display',
            'route_type', 'route_type_display', 'length', 'fiber_count', 'route_photo',
            'route_photo_url', 'documentation', 'installation_notes', 'technical_specs',
            'installed_date', 'tested_date', 'test_results', 'notes', 'is_active',
